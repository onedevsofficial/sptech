...
// Web3Forms's hCaptcha site key — this is the public key used by all
// Web3Forms accounts when hCaptcha is enabled in the dashboard.
...
declare global {
  interface Window {
    hcaptcha?: {
      ...
      render: (container: HTMLElement, params: { sitekey: string }) => unknown;
    };
  }
}
...
export default function Contact() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Time-trap — humans don't submit in <1s.
    ...
    fd.append("subject", `[Enquiry] ${fd.get("name") || "Website"} — sptechweb.site`);
    ...
    try {
      ...
      if (data?.success) {
        ...
        try {
          ...
          /* ignore — widget not yet rendered */
        }
      } else {
        setStatus("error");
        setErrorMsg(
      ...
      setStatus("error");
      setErrorMsg(
        "Network error. Please check your connection or WhatsApp us at +91 70033 91355."
      );
    }
  };
        ...
        <div className="container">
          <div className="grid lg:grid-cols-[1fr_1.1fr] gap-12 items-start">
            ...
            <form onSubmit={onSubmit} className="card p-6 sm:p-8" noValidate>
              ...
              <div className="mt-6 grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select id="service" name="service" defaultValue="">
                    ...
                    <option value="Website at ₹999/month">Website at ₹999/month</option>
                    <option value="Business website plan">Business website plan</option>
                ...
                <div>
                  ...
                  <select id="budget" name="budget" defaultValue="">
                    ...
                    <option value="₹999/month plan">₹999/month plan</option>
                    <option value="₹2,499/month plan">₹2,499/month plan</option>
                    <option value="₹50k–₹1L (one-time)">₹50k–₹1L (one-time)</option>
                ...
                {/* hCaptcha widget — auto-rendered by https://js.hcaptcha.com/1/api.js */}
              ...
              >
                {status === "submitting" ? "Sending…" : "Send & get free audit"}
                {status !== "submitting" && (
              ...
              <p className="mt-3 text-center text-[12px] text-muted">
                Protected by hCaptcha and basic spam controls. Your data is
